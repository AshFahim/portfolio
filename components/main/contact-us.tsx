      ...
      >
        ...
        <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
            ...
            >
              ...
              <label htmlFor="email" className="flex flex-col">
                ...
                <input
                  ...
                  value={form.email}
                  onChange={handleChange}
                  placeholder="ex. fahimashiqurrahman@gmail.com"
          ...
          <motion.div
            ...
            className="xl:flex-1 xl:h-auto md:h-[650px] h-[450px] w-full"
          >
            <EarthCanvas />
          </motion.div>
        </div>
